...
1. [GitOps: Hub and Spoke Agent-Based Architecture with Sveltos on Kubernetes](https://medium.com/itnext/gitops-hub-and-spoke-agent-based-with-sveltos-on-kubernetes-42896f3b701a) 
...
[![Stargazers repo roster for @projectsveltos/addon-controller](//reporoster.com/stars/projectsveltos/addon-controller)](https://bytecrank.com/nastyox/reporoster/php/stargazersSVG.php?user=projectsveltos&repo=addon-controller)