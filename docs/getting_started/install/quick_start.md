...
An example list is found [here](../../addons/kustomize.md). For more information about the Sveltos and FluxCD integration, check out the [information](../../use_cases/gitops_integration/fluxcd_use_case_gitops.md).
