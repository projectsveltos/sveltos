...
- **Verify Installation Health**: The AI can instantly check the health of all Sveltos components on the management cluster and confirm that agents are correctly deployed across every managed cluster. This is the best starting point when something looks wrong.
