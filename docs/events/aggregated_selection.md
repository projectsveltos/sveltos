...
You should use `AggregatedSelection` when your selection criteria depend on the state or relationship between multiple resources of different kinds. A great use case is when you need to enforce a policy or automate a task based on the interaction of various components within your application.
