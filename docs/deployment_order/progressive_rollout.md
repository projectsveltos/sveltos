...
!!!info "Enterprise Feature"
    Test the **progressive rollout** capabilities with up to **two** `ClusterPromotion` instances for free. Need more than two clusters? Contact us at [`support@projectsveltos.io`](mailto:support@projectsveltos.io) to explore license options.
